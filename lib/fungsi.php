...
function hitung_waktu_pinjam($tanggalmulai, $tanggalselesai){

$tgl1 = $tanggalmulai;  
// 1 Oktober 2009 
$tgl2 = $tanggalselesai;  // 10 Oktober 2009 
...
function tampilHari($tglane){
	$tanggal = strtotime($tglane);
