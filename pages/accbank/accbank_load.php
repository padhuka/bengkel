          ...
          <tr valign="middle">
            ...
            <td width="35%">
              <table><tr><td><input type="text" class="form-control" id="idaccbank" name="idaccbank" readonly style="width: 95%"></td><td>
                                <button type="button" class="btn btn-primary btn-md" data-toggle="modal" data-target="#myModal" onclick="open_addbank();" id="buttonaddbank">Pilih</button></td></tr></table>
              </td>
           <td width="10%"></td>
...
<br>
      ...
      <table id="example1" class="table table-condensed table-bordered table-striped table-hover">
                ...
                <?php
                                    $j=1;
                                    $sqlcatat = "SELECT A.*,A.description AS descrip, B.description AS nmakun,C.description AS nmref FROM t_acc_bank A LEFT JOIN t_akun B ON A.fk_akun=B.coa LEFT JOIN t_akun C ON A.ref_akun=C.coa ORDER BY A.tr_date DESC";
