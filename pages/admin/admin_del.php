                    ...
                    <div class="modal-header">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <form>
                                    <div class="alert alert-danger">Apakah anda yakin ingin menghapus data ini ( <?php echo $emp['username'];?>) ?</div>  
                                        
                                        <div class="form-group">                
                                            <input type="hidden" id="id" name="id" value="<?php echo $id;?>">
                                            <input type="hidden" id="username" name="username" value="<?php echo $emp['username'];?>">
                ...
                <script type="text/javascript">
                  $(document).ready(function (){
                        $(".save_submit").click(function (e){
                            var id = $('#id').val();
                           $.ajax({
                                url: 'admin/admin_del_save.php?id='+id,
                                type: 'GET',
