<?php
        ...
        $kodebaru = $kodeawal.$kodeakhir;         
            ...
            $sqltbemp = "INSERT INTO t_estimasi (id_estimasi,fk_no_chasis,fk_no_mesin,fk_no_polisi,km_masuk,fk_user,fk_asuransi,fk_customer) VALUES ('$kodebaru','$chasis','$mesin','$polisi','$kmmasuk','$uname','$kategori','$customer')";
