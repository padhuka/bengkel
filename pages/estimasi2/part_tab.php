    ...
    <div class="modal-content modern-modal-content">
        <div class="modal-header modern-modal-header">
            ...
            <h4 class="modal-title modern-modal-title" id="myModalLabel">
                ...
                Manajemen Part Estimasi
            </h4>
        </div>

        <div class="modal-body modern-modal-body">
            <!-- Part Table Section -->
            <div class="part-table-section">
                <div class="table-header">
                    <div class="table-title">
                        <h5><i class="fa fa-list"></i> Daftar Part</h5>
                    </div>
                    <div class="table-controls">
                        <button type="button" class="btn btn-modern-primary" onclick="addPart()">
                            <i class="fa fa-plus"></i>
                            Tambah Part
                        </button>
                    </div>
                </div>
                <div id="tablepart" class="modern-table-container">
...
<!-- Modal Containers for Part CRUD -->
<div id="ModalAddPart" class="modal modern-modal fade" tabindex="-1" role="dialog" aria-hidden="true"></div>
<div id="ModalEditPart" class="modal modern-modal fade" tabindex="-1" role="dialog" aria-hidden="true"></div>
<div id="ModalDeletePart" class="modal modern-modal fade" tabindex="-1" role="dialog" aria-hidden="true"></div>
...
function addPart() {
    $.ajax({
        url: "estimasi/part_add.php?idestimasi=<?php echo $idestimasi; ?>",
        type: "GET",
        ...
        error: function() {
            showNotification('Gagal memuat form tambah part', 'error');
        }
    });
}
