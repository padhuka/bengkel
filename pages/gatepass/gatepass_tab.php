  ...
  <div class="content-wrapper">
    ...
    Data Gate Pass
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Data Gate Pass</li>
      </ol>
    </section>
    ...
    <!-- /.content -->
        ...
        <div id="ModalGateAdd" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
