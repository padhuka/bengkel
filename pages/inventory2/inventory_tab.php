      ...
      <div class="container-fluid">
        <div class="page-header-content">
          <div class="page-title-section">
            ...
            <p class="page-subtitle">Kelola data kendaraan dan inventori bengkel</p>
          </div>
          <div class="page-actions">
            <button type="button" class="btn btn-modern-primary btn-add-inventory" id="addInventoryBtn">
        ...
        <div class="modern-table-section">
          <div class="table-header">
            <div class="table-title">
              <h2><i class="fa fa-list"></i> Daftar Inventory</h2>
            </div>
          ...
          <div class="table-container">
            <div id="tableinventory" class="modern-table-wrapper">
  ...
  <div id="ModalTipe" class="modal modern-modal fade" tabindex="-1" role="dialog" aria-hidden="true"></div>
  <div id="ModalWarna" class="modal modern-modal fade" tabindex="-1" role="dialog" aria-hidden="true"></div>
  <div id="ModalCustomer" class="modal modern-modal fade" tabindex="-1" role="dialog" aria-hidden="true"></div>
