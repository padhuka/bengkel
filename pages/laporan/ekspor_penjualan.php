      ...
      <table id="tablepkb1" class="table table-condensed table-bordered table-striped table-hover">
                ...
                <?php
                                   //WHERE p.tgl_batal='0000-00-00 00:00:00' AND p.status_pkb='' AND substring(tgl,1,10)>='$tgl1' AND  substring(tgl,1,10)<='$tgl2' 
                                    ...
                                    $j=1;
                                    $jml=0;
                                    $sqlcatat ="SELECT gt.no_gate_pass as nogate, k.tgl_kwitansi as tgl,k.no_kwitansi,k.fk_pkb as no_pkb,p.fk_no_polisi as no_polisi
                                    ...
                                    from t_kwitansi k 
                                    left join (select * from t_pkb where tgl_batal='0000-00-00 00:00:00') as p on k.fk_pkb=p.id_pkb left join t_customer c on p.fk_customer=c.id_customer
                                    ...
                                    left join t_gate_pass gt on k.fk_pkb=gt.fk_pkb
                                    where k.tgl_batal='0000-00-00 00:00:00' AND substring(tgl,1,10)>='$tgl1' AND 
                                      substring(tgl,1,10)<='$tgl2'";
