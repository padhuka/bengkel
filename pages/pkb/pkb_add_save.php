<?php
  ...
  //EST.BR.020818.000001
        ...
        $kodebaru = $kodeawal.$kodeakhir;
            ...
            $qpanelest=mysqli_query($objConn, $sqlpanelest);
            while($hpanelest=mysqli_fetch_array($qpanelest)){
                ...
                mysqli_query($objConn, $sqlpanelpkb);

            }

            $sqlpartest="SELECT * FROM t_estimasi_part_detail WHERE fk_estimasi='$idestimasi'";
            $qpartest=mysqli_query($objConn, $sqlpartest);
            while($hpartest=mysqli_fetch_array($qpartest)){
                ...
                mysqli_query($objConn, $sqlpartpkb);

            }
            
                $sqlstatus= "INSERT INTO t_status_pkb(fk_pkb) VALUES ('$kodebaru')";
                mysqli_query($objConn, $sqlstatus);
