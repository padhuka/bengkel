...
<div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Tambah Data Warna</h4>
                    </div>
                    ...
                    <form class="form-horizontal" enctype="multipart/form-data" novalidate id="formWarna">
                        <div class="form-group">
                          ...
                          <div class="col-sm-8">
                            <input type="text" class="form-control" id="id_warna_kendaraan" name="id_warna_kendaraan" required>
                          </div>
                        </div>
                        <div class="form-group">
                          <div class="col-sm-3">
                            <label for="namawarna">Nama</label>
                          </div>
                          <div class="col-sm-8">
