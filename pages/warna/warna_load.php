      ...
      <table id="warna1" class="table table-condensed table-bordered table-striped table-hover">
                ...
                <?php
                        ...
                        <tr>
                          ...
                          <td >
                                        <button type="button" class="btn btn btn-default btn-circle" id="<?php echo $catat['id_warna_kendaraan']; ?>" onclick="open_modal(ideditwarna='<?php echo $catat['id_warna_kendaraan']; ?>');"><span>Edit</span></button>
                                         <button type="button" class="btn btn btn-default btn-circle" id="<?php echo $catat['id_warna_kendaraan']; ?>" onclick="open_del(iddelwarna='<?php echo $catat['id_warna_kendaraan']; ?>');"><span>Hapus</span></button>
